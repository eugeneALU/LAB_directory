...
int main(void) {
  ...
  // jpegtest();
	...
	int size, code, addr, result1, result2, result3;
  asm volatile("l.mtspr %0, %1, 0x0" : : "r"(0xc002), "r"(0x01010148)); 
  ...
  //printf("ADDR: %x  CODE: %x  SIZE: %x\n", addr, code, size);
	
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x0001), "r"(1));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x0002), "r"(2));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x0004), "r"(3));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x0008), "r"(4));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x0010), "r"(5));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x0020), "r"(6));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x0040), "r"(7));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x0080), "r"(8));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0xffff), "r"(16));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x000f), "r"(4));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x000f), "r"(4));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x0001), "r"(1));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0xffff), "r"(16));
  asm volatile("l.sd 0x0(%0), %1" : : "r"(0x0008), "r"(4));
  ...
  result1 = REG32(0x01010148);
  result2 = REG32(0x0101014c);
  result3 = REG32(0x0101014a);
	  printf("RESULT1: %x\n", result1);
	  printf("RESULT2: %x\n", result2);
	  printf("RESULT3: %x\n", result3);
